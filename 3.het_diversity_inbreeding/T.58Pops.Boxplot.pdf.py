...
regionOrderDict={"ISEA":1,"South_Asia":2,"MSEA":3,"East_Asia":4,"Europe":5,"ISEA":6}
...
for line in filename:
    ...
    if lines[22] == "keep":
        print lines[1]
        if lines[17] in popsDict.keys():
            
            popsDict[lines[17]].append(value)
        else:
            popsDict[lines[17]]=[value]
            #print lines[17]
            regionNum=regionOrderDict[lines[18]]
            popsLabel[lines[17]]=[lines[17],lines[18],lines[19],lines[20],value,regionNum] #cut -f18-21 -> China_Bamei     EastAsian       blue    #7719AA
filename.close()
...
plt.xticks([x + 1 for x in range(len(all_data))], pops,rotation=90,fontproperties=font6)
...
fig.savefig("Cjh5group.58Pops.Heterozygosity.autosome.Boxplot.8-2.pdf", bbox_inches='tight') 

#inbreeding coefficient
#fig.savefig("Cjh5group.58Pops.Inbreeding.Coefficient.autosome.Boxplot.8-2.pdf", bbox_inches='tight') 
