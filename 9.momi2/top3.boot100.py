...
def plot_demography(model, filename, bootstrap_results=None):
    ...
    plt.savefig(f"warthog.pakibangledesh.{filename}")
...
plot_demography(no_migration_model, "no_migration_modeltop3.pdf")
...
migration_sus_to_ISEAWB_model.add_pulse_param("mfrac_sus_ISEAWB", lower=0.1, upper=0.3)
...
plot_demography(migration_sus_to_ISEAWB_model, "migration_sus_to_ISEAWB_modeltop3.pdf")
...
plot_demography(migration_sus_to_ISEAWB_model, "migration_sus_to_ISEAWB_model_bootstraptop3.pdf", bootstrap_results=bootstrap_results)
